...
[
  ...
  },
  {
    ...
    description: "Provides a secure, light-weight, and customizable foundation for building OpenID Connect 1.0 Identity Providers and OAuth2 Authorization Server products.",
    version: "1.5.1",
  ...
  {
    name: "Spring AI",
    description: "Spring AI is an application framework for AI engineering. At its core, Spring AI addresses the fundamental challenge of AI integration: Connecting your enterprise Data and APIs with the AI Models.",
    version: "1.0.0",
    extraVersions: "+ 1 versions",
...
const content = projects.map(item => `
  <div class="main-content-item-wrapper">
    <div class="item-header">
      <img src="${item.icon}" alt="${item.name}" class="main-logo" />
